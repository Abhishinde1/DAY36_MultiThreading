...
namespace MultiThread
{
    ...
    {
        public static string connectionString = @"Server=(localdb)\MSSQLLocalDB;Database=Payroll_Service;Trusted_Connection=SSPI;Encrypt=false;TrustServerCertificate=true";
	...
	BasicPay,Deduction,TaxablePay,Tax,NetPay,City,Country from Day36_Payroll_Service";
        ...
        public bool AddEmployee(EmployeeDetail employeeModel)
        {
            try
            {
                using (connection)
